import 'package:chryso_calculator/calcButton.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: SafeArea(
        ...
        //Los widgets hijos de la columna se alinean al final (parte inferior de la pantalla)
        children: [
          Align(
          ...
          //Snippet de los botones
          //llama a calcButton
          Row(
                mainAxisAlignment: MainAxisAlignment.spaceEvenly,  //separar igualmente
                children: [
